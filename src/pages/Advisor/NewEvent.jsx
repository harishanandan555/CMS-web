...
function EventRegistrationForm() {
  ...
  const onSubmit = (data) => {
    ...
    fetch(`${API_BASE_URL}/v1/cms/create/event`, {
      method: "POST",
      headers: {
                    ...
                    {step === 1 && (
                      <>
                        ...
                        <div className="mb-3">
                          ...
                          <select className="form-select" {...register("visibleTo", { required: true })}>
                            <option value="">Select</option>
                            <option value="Distributors">Distributors</option>
                            <option value="Customers">Customers</option>
                            <option value="Both">Both</option>
                          </select>
                          {errors.visibleTo && <p className="text-danger">Please select visibility.</p>}
                        </div>
                        ...
                        <div className="mb-3">
                          ...
                          <select className="form-select" {...register("language", { required: true })}>
                            ...
                            <option value="German">Telugu</option>
                            <option value="Other">Tamil</option>
                          </select>
                          {errors.language && <p className="text-danger">Please select a language.</p>}
                        </div>

                        <div className="mb-3">
                          <label className="form-label">Event Time</label>
                          <input type="time" {...register("eventTime", { required: true })} className="form-control" />
                          {errors.eventTime && <p className="text-danger">Event time is required.</p>}
                        </div>
                        ...
                        <div className="mb-3">
                          ...
                          {errors.duration && <p className="text-danger">Duration must be at least 1 hour.</p>}
                        </div>
