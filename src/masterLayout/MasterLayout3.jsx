      ...
      >
        ...
        <div className='sidebar-menu-area'>
          ...
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            {/* <li>
  <NavLink to="/advisor-customer" className={(navData) => (navData.isActive ? "active-page" : "")}>
...
<li>
  <NavLink to="/advisor-event" className={(navData) => (navData.isActive ? "active-page" : "")}>
